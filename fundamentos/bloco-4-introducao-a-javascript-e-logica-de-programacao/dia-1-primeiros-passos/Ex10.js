...
const custoDoProduto = 1500;
const imposto = 1.2;
const valorDeVenda = 2000;

if (custoDoProduto >= 0 && valorDeVenda >= 0) {
	const valorCustoTotal = custoDoProduto + imposto;
	let lucro = (valorDeVenda - valorCustoTotal) * 1000;
	console.log("R$", lucro.toFixed(0), "reais.");
} else {
	console.log("Erro. Não pode haver valores negativos");
}
